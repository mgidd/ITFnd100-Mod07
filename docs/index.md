...
![Figure 10](https://github.com/mgidd/ITFnd100-Mod07/blob/master/docs/Figure10.png "Figure 10")
#### Figure 10

When the user selects option 2, they are prompted to enter a title, which is then added to the list (Figure 11).

![Figure 11](https://github.com/mgidd/ITFnd100-Mod07/blob/master/docs/Figure11.png "Figure 11")
#### Figure 11

When the user selects option 3, they are prompted to enter a title, which is then removed from the list (Figure 12).

![Figure 12](https://github.com/mgidd/ITFnd100-Mod07/blob/master/docs/Figure12.png "Figure 12")
#### Figure 12

When the user selects option 1, the current list is displayed (Figure 13).

![Figure 13](https://github.com/mgidd/ITFnd100-Mod07/blob/master/docs/Figure13.png "Figure 13")
#### Figure 13

If there are no items in the current list, the user will be notified (Figure 14).

![Figure 14](https://github.com/mgidd/ITFnd100-Mod07/blob/master/docs/Figure14.png "Figure 14")
#### Figure 14

When the user selects option 6, the program ends and the user is notified (Figure 15).

![Figure 15](https://github.com/mgidd/ITFnd100-Mod07/blob/master/docs/Figure15.png "Figure 15")
#### Figure 15
...
![Figure 16](https://github.com/mgidd/ITFnd100-Mod07/blob/master/docs/Figure16.png "Figure 16")
#### Figure 16

The user can add and remove titles from the list (Figure 17).

![Figure 17](https://github.com/mgidd/ITFnd100-Mod07/blob/master/docs/Figure17.png "Figure 17")
#### Figure 17

And the user can save created lists to a file (Figure 18).

![Figure 18](https://github.com/mgidd/ITFnd100-Mod07/blob/master/docs/Figure18.png "Figure 18")
#### Figure 18

To verify that the list was saved, I checked the specified file for the binary data (Figure 19).

![Figure 19](https://github.com/mgidd/ITFnd100-Mod07/blob/master/docs/Figure19.png "Figure 19")
#### Figure 19
